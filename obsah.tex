...
komponenta stále spĺňa špecifikované požiadavky.}
...
v~čase spustenia daného testu úspešne \uvodzovky{aktivované}. 
...
\section{Možnosti distribúcie testov}
...
Z~tabuliek vyplýva, že produkt MCO má priemerné dĺžky trvaní clusterov, 
...
V~nasledujúcej časti sa pozrieme na navrhnuté možnosti distribúcie 
...
Príkladom výsledku môže byť distribúcia testov na dva testovacie systémy, 
...
\subsection*{Neželaná distribúcia testov}
...
\begin{lstlisting}[caption=Inštalácia produktu MCO na troch testovacích systémoch súčasne,
...
Pre nastavenie počtu systémov, na ktoré chceme distribuovať  
...
\begin{lstlisting}[caption=Informácie zobrazované po naplánovaní regresných testoch,
...
Prvá optimalizácia algoritmu distribúcie testov sa snaží minimalizovať
...
\begin{table}
  \begin{center}
    ...
    \end{tabular}
    \caption{Prínos použitia distribúcie testov pre rôzny počet 
...
\section{Porovnanie jednotlivých optimalizácii}
...
\begin{table}
  \begin{center}
    \begin{tabular}{ | C{2.9cm} | C{2.8cm} | C{2.51cm} | C{2.51cm} | C{2.51cm} | }
      ...
      počet testovacích systémov & bez optimalizácii & optimalizácia 1 & optimalizácia 2 & optimalizácia 3 \\ \hline
...
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{ | C{1.5cm} | C{4cm} | C{4.5cm} | }
      ...
      5 &   -   &  05:30 \\ \hline
    \end{tabular}
    \caption{Porovnanie vplyvu optimalizácie 2 na testovacie
             systémy pri plánovaní funkcionality \textit{addrtran}}
